...
<a class="waves-effect waves-light btn center blue" href="<?php echo base_url() . "index.php/question/generate/";?>"><i class="material-icons right">assignment_ind</i>Generer une question</a>
</br>
</br>
<div class="container">
	<div class="row">
