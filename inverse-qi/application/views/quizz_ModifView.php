...
<div class="container white client_create z-depth-2 " style="padding:20px;">
	<h2>Modifier le Quizz</h2>

	<?php echo validation_errors(); ?>


	<form action="<?php echo base_url() . "index.php/test/Quizz_Modif"; ?>" method="post">
		...
		<div class="row">
			...
			<div class="input-field col s12">
				...
				<input type="text" name="Nom" value="<?php echo $name->Nom; ?>" size="32"/>
				<input type="hidden" name="idquizz" value="<?php echo $name->idQuizz; ?>"></span>
				<?php endforeach; ?>
			</div>
		...
		<div class="row">
			...
			<div id="listeChoix" class="col s5 collection with-header">
				...
				<?php foreach ($listeChoix as $question1): ?>
					<p id="question<?php echo $question1->idQuestion; ?>">
						<label>
							<input type="checkbox" name="question<?php echo $question1->idQuestion; ?>"
								   value="<?php echo $question1->idQuestion; ?>" class="checkbox-selection" checked/>
							<span><?php echo $question1->Intitule; ?></span>
						</label>
					</p>
				<?php endforeach; ?>
