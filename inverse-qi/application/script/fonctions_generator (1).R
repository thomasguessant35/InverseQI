...
gener_iq  = function(){
  ...
  if(samsam == 1){
    if(sam_h == 1){
      ...
      print(" Horizontalement : R�p�tition horizontale")
      if(sam_v == 1){
    ...
    if(sam_h == 2){
      ...
      print("Horizontalement : D�placement horizontal")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_h == 3){
      ...
      print("Horizontalement : D�placement vertical ")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_h == 6){
      ...
      print("Horizontalement : D�placement diagonale bas droite ")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_h == 7){
      ...
      print("Horizontalement : D�placement diagonale bas gauche ")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_h == 8){
      ...
      print("Horizontalement : D�placement diagonale haut droite ")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_h == 9){
      ...
      print("Horizontalement : D�placement diagonale haut gauche ")
      if(sam_v == 1){
        print(" Verticalement : Repetition verticale")
      }
      if(sam_v == 2){
    ...
    if(sam_v == 2){
      ...
      print("D�placemnt horizontal verticalement")
    }
    if(sam_v == 3){
      question = gener_question_v(vecteurs, list_h[[sam_h]], list_v[[sam_v]], gener_dep_v_v)
      print("D�placement vertical verticalement")
    }
    if(sam_v == 4){
    ...
    if(sam_h == 1){
      print("Horizontalement : R�p�tition")
    }
    if(sam_h == 2){
...
library(tensorflow)
  ...
  model %>% 
    layer_dense(units =128, input_shape =18, activation = "relu") %>%  # pour la première couche, il faut indiquer le nombre d'input 
    # dans input_shape, et le nombre de neurones de la couche cachée dans units.
    layer_dense(units = 64, activation = "relu") %>%
    # On choisit d'abord une activation linéaire sur cette couche (par défaut, donc rien à écrire)
    layer_dense(units = 9, activation = "relu") # couche de sortie : 1 neurone dont la valeur de sortie représente la proba 
  # d'être de la classe 1 (activation sigmoid, toujours pour la couche de sortie en classification)
  model %>% compile(
